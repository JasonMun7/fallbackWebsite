...
function initializeParticleground() {
  // Check if the elements with IDs exist in the DOM
  const foregroundElement = document.getElementById('particles-foreground');
  const backgroundElement = document.getElementById('particles-background');

  if (foregroundElement && backgroundElement) {
    // Call particleground only if the elements exist
      ...
      <div className="vertical-centered-box">
        <div className="content">
          <div className="loader-circle relative">
            <img src={jasonFallbackLogo} alt="Jason's Logo" className="absolute rounded-3xl w-10 h-auto left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2"
            />
          </div>
